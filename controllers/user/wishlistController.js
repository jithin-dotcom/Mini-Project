...
//             // If stock for the selected size is zero or less, return false to filter out the item
//             return availableStock > 0;
//         });

//         // If there are items removed (i.e., stock for size is zero), update the wishlist
//         if (updatedItems.length !== wishlist.items.length) {
//             wishlist.items = updatedItems;  // Update the wishlist items list
//             await wishlist.save();  // Save the updated wishlist
//         }
