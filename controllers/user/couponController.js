...
//             const total = req.session.totalPrice; // Assuming total is stored in session
//             const newTotal = total - coupon.offerPrice;

//             // Update the total price in session
//             req.session.totalPrice = newTotal;
...
//apply coupon without used coupon 
...
//             const total = req.session.totalPrice ; // Assuming total is stored in session
//             const newTotal = total - coupon.offerPrice;
//             req.session.totalPrice  = newTotal; // Update total in session
//             res.json({ success: true, newTotal });
//         } else {
//             res.json({ success: false, message: 'Invalid or expired coupon.' });
//         }
