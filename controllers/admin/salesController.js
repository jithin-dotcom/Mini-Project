...
//             // doc.text(`Coupon Applied: ${order.couponApplied ? 'Yes' : 'No'}`);
...
//         doc.text(tableHeaders[1], 150, headerY);
//         doc.text(tableHeaders[2], 250, headerY);
//         doc.text(tableHeaders[3], 350, headerY);
//         doc.text(tableHeaders[4], 450, headerY);
//         doc.text(tableHeaders[5], 550, headerY);
//         doc.moveDown();
...
//             doc.text(new Date(order.createdOn).toLocaleDateString('en-US'), 150, rowY);
//             doc.text(`₹${order.totalPrice}`, 250, rowY);
//             doc.text(`₹${order.discount}`, 350, rowY);
//             doc.text(`₹${order.finalAmount || order.totalPrice}`, 450, rowY);
//             doc.text(order.status, 550, rowY);
